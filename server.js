...
app.post('/api/settings', authMiddleware, adminMiddleware, async (req, res) => {
  const { spin_price, sp_to_shhht, tasks, home_boost_tasks, stake_task, tap_boost_price, tap_boost_amount, withdrawal_min, mysteryBoxes, adsTasks, ads_tasks, og_pass_stars_price, og_pass_gram_price, spin_stars_price, shop_boosts } = req.body;
  try {
